  ...
  return (
    <div className="min-h-screen flex flex-col bg-black">
      ...
      <main className="flex-1 relative overflow-hidden pt-8">
        ...
        {/* Content overlay */}
        <div className="relative z-10 bg-black/5 backdrop-blur-[2px] mt-8">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="max-w-4xl mx-auto">
              ...
              {/* Main Description */}
              <div className="bg-black/5 backdrop-blur-[2px] rounded-lg shadow-sm border border-white/10 p-8 mb-8">
                <p className="text-lg text-gray-100 leading-relaxed mb-6 drop-shadow-xl">
                  This is a comprehensive full-stack web application built with modern technologies including{" "}
                  <span className="font-semibold text-green-400 drop-shadow-lg">MongoDB</span> for database management,{" "}
                  <span className="font-semibold text-cyan-400 drop-shadow-lg">React</span> for dynamic user interfaces,{" "}
                  <span className="font-semibold text-yellow-400 drop-shadow-lg">Node.js</span> for server-side runtime,
                  and <span className="font-semibold text-white drop-shadow-lg">Next.js</span> for the React framework
                  with enhanced features.
                </p>
                <p className="text-lg text-gray-100 leading-relaxed drop-shadow-xl">
                  This project serves as both a learning platform and a practical demonstration of how these
                  technologies work together to create scalable, maintainable, and performant web applications.
                </p>
              </div>

              {/* Modern Practices Section */}
              <div className="bg-black/5 backdrop-blur-[2px] rounded-lg shadow-sm border border-white/10 p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="p-6 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10">
                    ...
                    <p className="text-gray-200 text-sm leading-relaxed drop-shadow-lg">
                      Leveraging Next.js App Router for improved SEO, faster initial page loads, and better user
                      experience through pre-rendered content and optimized performance.
                    </p>
                  </div>
                  ...
                  <div className="p-6 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10">
                    ...
                    <p className="text-gray-200 text-sm leading-relaxed drop-shadow-lg">
                      Implementation of robust authentication systems with encrypted passwords, secure session
                      management, and JWT tokens to protect user data and ensure secure access.
                    </p>
                  </div>
                  ...
                  <div className="p-6 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10">
                    ...
                    <p className="text-gray-200 text-sm leading-relaxed drop-shadow-lg">
                      Sophisticated authorization system with different user roles and permissions, ensuring users can
                      only access features and data appropriate to their access level.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center mt-12">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button
                    size="lg"
                    className="bg-blue-600/60 hover:bg-blue-700/70 backdrop-blur-sm border border-blue-400/30 text-white font-semibold shadow-2xl"
                    asChild
                  >
                  ...
                  <Button
                    variant="outline"
                    size="lg"
                    className="bg-white/5 hover:bg-white/10 text-white backdrop-blur-sm border border-white/20 shadow-2xl"
                    asChild
                  >
